package com.xiaomi.be.example.wordcount.mailbox;
...
public class WordCountPriorityMailBox extends UnboundedPriorityMailbox {
    /**
     * 创建一个自定义优先级的无边界的邮箱. 用来规定命令的优先级. 这个就保证了DISPLAY_LIST 这个事件是最后再来处理.
     */
    public WordCountPriorityMailBox(ActorSystem.Settings settings, Config config) {
